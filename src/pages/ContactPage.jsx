...
import { div } from 'framer-motion/client'; // Ongebruikte import van div uit framer-motion, kan worden verwijderd

const ContactPage = () => {
    return (
        <div className="w-full h-auto flex flex-col items-center">
            <div className="w-[90%] xl:w-[80%] 2xl:w-[70%] h-auto top-[50px] lg:top-[80px] gap-[90px] relative flex flex-col">
                {/* Eerste sectie met titel en beschrijving */}
                <div className="w-full h-auto flex flex-col md:flex-row gap-[20px] justify-around items-center">
                    ...
                    {/* Afbeelding die alleen op grotere schermen wordt weergegeven */}
                ...
                {/* Grid sectie met verschillende contactopties */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 lg:gap-x-30 gap-y-20 w-full h-full mb-[80px]">
                    ...
                    <div className="flex flex-col items-center gap-[20px] text-center">
                        <img draggable="false" className='select-none w-full h-auto rounded-[30px] hover:scale-[1.02] transition-all duration-300 ease-in-out' src={maps} alt="Contact Form" />
                    ...
                    {/* Social Media sectie */}
                    <div className="flex flex-col items-center gap-[20px] text-center">
                        <img draggable="false" className='select-none w-full h-auto rounded-[30px] hover:scale-[1.02] transition-all duration-300 ease-in-out' src={socials} alt="Social Media" />
                        <div className='flex flex-col text-start w-full'>
                    ...
                    <div className="flex flex-col items-center gap-[20px] text-center">
                        <img draggable="false" className='select-none w-full h-auto rounded-[30px] hover:scale-[1.02] transition-all duration-300 ease-in-out' src={maps} alt="Additional Information" />
                        <div className='flex flex-col text-start w-full'>
                    ...
                    {/* Locatie op de kaart sectie */}
                    <div className="flex flex-col items-center gap-[20px] text-center">
                        <img draggable="false" className='select-none w-full h-auto rounded-[30px] hover:scale-[1.02] transition-all duration-300 ease-in-out' src={maps} alt="Find Us on Map" />
                        <div className='flex flex-col text-start w-full'>
