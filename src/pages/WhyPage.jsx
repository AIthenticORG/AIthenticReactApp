            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex w-full lg:w-1/2 justify-center items-center">
                    <div className="w-full h-full flex justify-center items-center p-5 rounded-lg">
                        ...
                        {/* De tweede afbeelding wordt getoond in de rechterhelft */}
                    </div>
                </div>
                <div className="w-full lg:w-1/2 flex flex-col gap-6 mt-[0px] md:mt-[50px]">
                    ...
                    {/* Uitleg over de onzekerheden die AI met zich meebrengt */}
                    <p className="text-sm md:text-base leading-relaxed">
                    ...
                    {/* Lijst van vragen die organisaties zich kunnen stellen bij de implementatie van AI */}
                    <p className="text-sm md:text-base leading-relaxed">
                    ...
                    {/* Verklaring over hoe het ecosysteem van AIthentic organisaties helpt met AI-integratie in de zorg */}
                </div>
            </div>
        </div>
