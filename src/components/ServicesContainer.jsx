const ServicesContainer = () => {
    return(
        <div className="h-[auto] w-full flex justify-center md:flex-row flex-col items-center">
            <div className="h-[500px] w-[300px] m-[50px] rounded-[20px] text-center border border-[1px]">
                <div className="h-[15%] flex items-center justify-center">
                    <h1 className="text-black font-bold text-3xl">Innovatie</h1>
                </div>              
                <div className="h-[85%] bg-[#36939F] rounded-[20px]">
            ...
            <div className="h-[500px] w-[300px] m-[50px] rounded-[20px] text-center border border-[1px] md:mt-[200px]">
                <div className="h-[15%] flex items-center justify-center">
