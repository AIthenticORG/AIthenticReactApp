// Importeer afbeeldingen van verschillende merken en personen
...
// Importeer het component dat de schuivende afbeeldingselementen toont
import ImageSliderItems from './ImageSliderItems';

// Component voor de afbeeldingenslider
const ImageSlider = () => {
    // Lijst van afbeeldingen die herhaald worden om een continue slider te creëren
    const images = [
    ...
    return (
        // Container met een lineaire achtergrond en verticale centrering
        <div className="w-[full] h-[320px] lg:h-[400px] bg-gradient-to-r from-gray-300 via-white to-gray-200 flex flex-col items-center justify-evenly">
            ...
            <h1 className='text-[#0D5B58] text-[25px] lg:text-[32px] font-bold text-center'>
                These companies didn't hesitate
            </h1>

            {/* Slider component dat de afbeeldingen horizontaal laat schuiven */}
