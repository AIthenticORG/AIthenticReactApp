        ...
        <div className='w-full h-full p-6 flex items-center justify-center'>
            {currentType === 'one' && (
                ...
                <div className='w-full sm:w-1/3 flex justify-center'>
                    <img draggable='false' src={bora} className='select-none w-full h-full object-cover bg-gray-300 rounded-lg hidden sm:block md:block' />
                </div>
                <div className='w-full sm:w-1/2 flex flex-col justify-center'>
                    ...
                    <img draggable='false' className='select-none h-[70px] xs:hidden' src={bora2} alt=""/>
                    </div>
                </div>
                </div>
            ...
            {currentType === 'two' && (
                ...
                <div className='flex flex-col sm:flex-row mt-6 w-full'>
                <div className='w-full sm:w-1/3 flex justify-center'>
                    <img draggable='false' src={voorbeeld} className='select-none w-full h-full object-cover bg-gray-300 rounded-lg hidden sm:block md:block' />
                </div>
                <div className='w-full sm:w-1/2 flex flex-col justify-center'>
                    <p className='text-lg font-medium italic text-gray-700 ml-[40px]'>
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor
                    ...
                    <div className='mx-4' style={{ height: '50px', width: '1px', backgroundColor: 'black' }}></div>
                    <img draggable='false' className='select-none h-[70px] hide-on-small' src={mac} alt="" />
                    </div>
                </div>
                </div>
                <div className='flex justify-between items-center w-full mt-6'>
            ...
            {currentType === 'three' && (
                ...
                <div className='flex flex-col sm:flex-row mt-6 w-full'>
                <div className='w-full sm:w-1/3 flex justify-center'>
                    <img draggable='false' src={jayropeters} className='select-none w-full h-full object-cover bg-gray-300 rounded-lg hidden sm:block md:block' />
                </div>
                <div className='w-full sm:w-1/2 flex flex-col justify-center'>
                    <p className='text-lg font-medium italic text-gray-700 ml-[40px]'>
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor
                    ...
                    <div className='mx-4' style={{ height: '50px', width: '1px', backgroundColor: 'black' }}></div>
                    <img draggable='false' className='select-none h-[70px] hide-on-small' src={jayro} alt="" />
                    </div>
                </div>
                </div>
                <div className='flex justify-between items-center w-full mt-6'>
